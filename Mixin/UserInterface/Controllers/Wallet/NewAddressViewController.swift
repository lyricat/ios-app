...
class NewAddressViewController: KeyboardBasedLayoutViewController {
    ...
    private func updateMemoTips() {
        ...
        if noMemo {
            if asset.usesTag {
                hint = R.string.localizable.address_memo_add(R.string.localizable.add_Tag())
                action = R.string.localizable.add_Tag()
            } else {
                hint = R.string.localizable.address_memo_add(R.string.localizable.add_memo())
                action = R.string.localizable.add_memo()
            }
            memoView.isHidden = true
        } else {
            if asset.usesTag {
                hint = R.string.localizable.address_memo_no(R.string.localizable.no_tag())
                action = R.string.localizable.no_tag()
            } else {
                hint = R.string.localizable.address_memo_no(R.string.localizable.no_Memo())
