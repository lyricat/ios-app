...
class AssetViewController: UIViewController {
    ...
    @IBAction func transfer(_ sender: Any) {
        ...
        let alc = UIAlertController(title: R.string.localizable.send_To(), message: nil, preferredStyle: .actionSheet)
        alc.addAction(UIAlertAction(title: R.string.localizable.contact_menu(), style: .default, handler: { [weak self] (_) in
