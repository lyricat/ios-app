...
extension UserProfileViewController {
    ...
    @objc func blockUser() {
        let userId = user.userId
        let alert = UIAlertController(title: R.string.localizable.blocked_contacts_hint(), message: nil, preferredStyle: .actionSheet)
        alert.addAction(UIAlertAction(title: R.string.localizable.cancel(), style: .cancel, handler: nil))
            ...
            if !user.isBot {
                let callGroup: [ProfileMenuItem] = {
                    ...
                    if let number = user.phone, !number.isEmpty {
                        group.append(ProfileMenuItem(title: R.string.localizable.call_Phone(),
                                                     subtitle: number,
                                                     style: [],
