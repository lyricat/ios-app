...
class GroupCallConfirmationViewController: CallViewController {
    ...
    override var membersCountText: String? {
        R.string.localizable.group_participants_count(members.count)
    }
    ...
    override func viewDidLoad() {
        ...
        membersCountLabel.text = R.string.localizable.group_participants_count(members.count)
        ...
        DispatchQueue.global().async {
            ...
            DispatchQueue.main.async {
                ...
                if self.isViewLoaded {
                    ...
                    self.membersCountLabel.text = R.string.localizable.group_participants_count(members.count)
