...
class ContactViewController: UITableViewController {
    ...
    @objc func reloadAccount() {
        ...
        DispatchQueue.main.async {
            ...
            self.accountIdLabel.text = R.string.localizable.contact_identity_number(account.identity_number)
        }
    }
    ...
    class func instance() -> UIViewController {
        ...
        let container = ContainerViewController.instance(viewController: vc, title: R.string.localizable.contacts())
        return container
    }
    ...
    override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        if section == 0 {
            if contacts.isEmpty {
                ...
                view.label.text = R.string.localizable.chat_forward_contacts()
                return view
            }
