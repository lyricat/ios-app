            ...
            WithdrawalAPI.save(address: address) { [weak self] (result) in
                ...
                case .failure(.malformedAddress):
                    ...
                    if self.asset.isEOSChain {
                        ...
                        message = R.string.localizable.invalid_malformed_address_detailed("Ethereum(ERC20) \(self.asset.symbol)")
                    } else {
                        message = R.string.localizable.invalid_malformed_address_detailed(self.asset.symbol)
                    }
